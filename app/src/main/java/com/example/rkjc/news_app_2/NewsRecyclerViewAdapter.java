...
public class NewsRecyclerViewAdapter  extends RecyclerView.Adapter<NewsRecyclerViewAdapter.NewsViewHolder> {
    ...
    public class NewsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        void bind(final int listIndex) {
            titleView.setText("Title :"+ newsdatalist.get(listIndex).getTitle());
            descriptionView.setText("Description :"+ newsdatalist.get(listIndex).getDescription());
            dateView.setText("Date :"+newsdatalist.get(listIndex).getPublishedAt());
            itemView.setOnClickListener(this);
        }

        @Override
        public void onClick(View view) {
            String urlString = newsdatalist.get(getAdapterPosition()).getUrl();
